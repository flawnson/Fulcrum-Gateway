...
export class OrganizerQueuesArgs {
  ...
  distinct?: Array<"id" | "join_code" | "name" | "address" | "state" | "capacity" | "max_party_size" | "grace_period" | "offline_time" | "create_time" | "password" | "organizer_id"> | undefined;
}
